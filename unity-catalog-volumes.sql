...
CREATE DATABASE IF NOT EXISTS quickstart_catalog
MANAGED LOCATION 's3://quickstartcatalog';
...
SHOW GRANTS ON DATABASE quickstart_catalog;
...
USE SCHEMA quickstart_catalog;

-- COMMAND ----------

DESCRIBE CATALOG quickstart_catalog;
DESCRIBE SCHEMA quickstart_catalog.quickstart_schema;
...
CREATE SCHEMA quickstart_catalog.quickstart_schema;

-- COMMAND ----------

SHOW SCHEMAS IN quickstart_catalog;
--- Create an external volume under the newly created directory
CREATE VOLUME IF NOT EXISTS 
 quickstart_catalog.quickstart_schema.quickstart_volume
...
SHOW VOLUMES IN quickstart_catalog.quickstart_schema;

-- COMMAND ----------

-- MAGIC %python
-- MAGIC display(dbutils.fs.ls("dbfs:/databricks-datasets/structured-streaming/events/file-0.json"))

-- COMMAND ----------

-- MAGIC %python
-- MAGIC f = open('/discover/databricks-datasets/README.md', 'r')
-- MAGIC print(f.read())
-- MAGIC
